...
public class VideoStore<T extends Comparable<T>> {
	...
	DLL<String, Video> videoInstore;
	DLL<Integer, Customer> customer;
 ...
 */
	...
	public static void main(String[] args) {
		...
		if(args.length < 3 && args[0].equalsIgnoreCase("DLL")) {
			
		
				testFunction(args[0]);
				
		}else if(args.length > 3 && args[0].equalsIgnoreCase("DLL")) {
		...
		public static void testFunction(String s) {
			...
			storeVideos.videoInstore = new DLL<String, Video>();
			storeVideos.c.rentVideo = new DLL<String, Video>();
			VideoStore<Customer> storeCustomers = new VideoStore<Customer>();
			storeCustomers.customer = new DLL<Integer, Customer>();
		int exit = 0;	
		...
		public static void testRunningTime(String s, String s1, String s2, String s3) {
			...
			storeCustomers.customer = new DLL<Integer, Customer>();
				...
				System.out.println("Total running time for DLL is : " + t3 + "milliseconds");
			}
