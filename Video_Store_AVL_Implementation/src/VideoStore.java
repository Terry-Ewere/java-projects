...
public class VideoStore<T extends Comparable<T>> {
	...
	AVL<String, Video> videoInstore;
	AVL<Integer, Customer> customer;
 ...
 */
	...
	public static void main(String[] args) {
		...
		if(args.length < 3 && args[0].equalsIgnoreCase("AVL")) {
			
		
				testFunction(args[0]);
				
		}else if(args.length > 3 && args[0].equalsIgnoreCase("AVL")) {
		...
		public static void testFunction(String s) {
			...
			storeVideos.videoInstore = new AVL<String, Video>();
			storeVideos.c.rentVideo = new AVL<String, Video>();
			VideoStore<Customer> storeCustomers = new VideoStore<Customer>();
			storeCustomers.customer = new AVL<Integer, Customer>();
		int exit = 0;	
		...
		public static void testRunningTime(String s, String s1, String s2, String s3) {
			...
			storeCustomers.customer = new AVL<Integer, Customer>();
				...
				System.out.println("Total running time for AVL ADT is : " + t3 + "milliseconds");
			}
