...
public class VideoStore<T extends Comparable<T>> {
	...
	BST<String, Video> videoInstore;
	BST<Integer, Customer> customer;
 ...
 */
	...
	public static void main(String[] args) {
		...
		if(args.length < 3 && args[0].equalsIgnoreCase("BST")) {
			
		
				testFunction(args[0]);
				
		}else if(args.length > 3 && args[0].equalsIgnoreCase("BST")) {
		...
		public static void testFunction(String s) {
			...
			storeVideos.videoInstore = new BST<String, Video>();
			storeVideos.c.rentVideo = new BST<String, Video>();
			VideoStore<Customer> storeCustomers = new VideoStore<Customer>();
			storeCustomers.customer = new BST<Integer, Customer>();
		int exit = 0;	
		...
		public static void testRunningTime(String s, String s1, String s2, String s3) {
			...
			storeCustomers.customer = new BST<Integer, Customer>();
				...
				System.out.println("Total running time for BST is : " + t3 + "milliseconds");
			}
